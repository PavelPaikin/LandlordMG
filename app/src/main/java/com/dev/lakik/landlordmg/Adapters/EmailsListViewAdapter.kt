...
class EmailsListViewAdapter(context: Context, var items: List<Tenant.Email>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View? {
        ...
        if (convertView == null) {
            view = this.mInflator.inflate(R.layout.lv_email_item_view, parent, false)
