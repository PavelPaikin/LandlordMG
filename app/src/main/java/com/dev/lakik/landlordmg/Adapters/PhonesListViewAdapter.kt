...
class PhonesListViewAdapter(context: Context, var items: List<Tenant.Phone>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View? {
        ...
        if (convertView == null) {
            view = this.mInflator.inflate(R.layout.lv_phone_item_view, parent, false)
