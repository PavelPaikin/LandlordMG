...
import kotlinx.android.synthetic.main.fragment_leases_active.*

class ActiveLeases : Fragment() {
    private var listener: OnFragmentInteractionListener? = null
    private lateinit var adapter: rvLeaseAdapter

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_leases_active, container, false)
    }
    ...
    companion object {
        var TAG = "ActiveLeases"

        fun newInstance(args: Bundle?): ActiveLeases {
            val fragment = ActiveLeases()
